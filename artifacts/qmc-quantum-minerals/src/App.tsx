...
const operationsImage = '/qmc-products/operations-field.jpg';
...
function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link href="/" className="brand-lockup group" data-testid="link-logo">
      <span className="relative flex h-11 w-11 shrink-0 items-center justify-center border border-[#d58442] text-[#e8aa62]">
        <span className="absolute h-6 w-6 rotate-45 border border-[#d58442]" />
        <span className="relative display-font text-[14px] font-bold tracking-[-.12em]">FQ</span>
      </span>
      {!compact && <span className="brand-name"><span className="display-font text-[19px] font-semibold leading-none tracking-[-.045em] text-[#f1e9db]">First Quantum</span><span className="mono-font text-[9px] uppercase tracking-[.18em] text-[#e8aa62]">Minerals</span></span>}
    </Link>
  );
}
...
function Header() {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50 border-b border-white/[.1] bg-[#101318]/70 backdrop-blur-md">
      <div className="mx-auto flex h-[84px] max-w-[1440px] items-center justify-between px-5 md:h-[92px] md:px-10">
        <Logo />
  ...
  return <footer className="border-t border-white/[.1] bg-[#0c0f12]">
    <div className="mx-auto max-w-[1440px] px-5 py-14 md:px-10 md:py-20">
      <div className="grid gap-12 md:grid-cols-[1.4fr_.8fr_.8fr_1fr]">
        <div><Logo /><p className="mt-6 max-w-[270px] text-sm leading-6 text-[#8d9495]">First Quantum Minerals supplies the materials and operating discipline behind a more connected world.</p><Link href="/contact" className="mt-7 inline-flex items-center gap-2 mono-font text-[10px] uppercase text-[#e8aa62]" data-testid="link-footer-contact">Talk to First Quantum <MoveUpRight size={13} /></Link></div>
        ...
        <div><p className="eyebrow mb-5">Connect</p><div className="grid gap-3"><Link href="/investors" className="text-sm text-[#adb1ae] hover:text-[#e8aa62]" data-testid="link-footer-investors">Investor centre</Link><Link href="/careers" className="text-sm text-[#adb1ae] hover:text-[#e8aa62]" data-testid="link-footer-careers">Join the team</Link><a href={`mailto:${CONTACT_EMAIL}`} className="text-sm text-[#adb1ae] hover:text-[#e8aa62]" data-testid="link-footer-email">Email First Quantum</a></div></div>
        <div><p className="eyebrow mb-5">Vancouver office</p><p className="text-sm leading-6 text-[#adb1ae]">Suite #1540<br />1100 Melville Street<br />Vancouver, B.C. Canada<br />V6E 4A6</p><div className="mt-7 flex items-center gap-4"><a href="https://www.linkedin.com" target="_blank" rel="noreferrer" aria-label="First Quantum Minerals on LinkedIn" className="text-[#8d9495] transition-colors hover:text-[#e8aa62]" data-testid="link-social-linkedin"><Linkedin size={16} /></a><a href="https://www.instagram.com" target="_blank" rel="noreferrer" aria-label="First Quantum Minerals on Instagram" className="text-[#8d9495] transition-colors hover:text-[#e8aa62]" data-testid="link-social-instagram"><Instagram size={16} /></a><a href="https://www.facebook.com" target="_blank" rel="noreferrer" aria-label="First Quantum Minerals on Facebook" className="text-[#8d9495] transition-colors hover:text-[#e8aa62]" data-testid="link-social-facebook"><Facebook size={16} /></a></div></div>
      </div>
      <div className="mt-16 flex flex-col gap-4 border-t border-white/[.1] pt-6 md:flex-row md:items-center md:justify-between"><p className="mono-font text-[9px] uppercase tracking-[.12em] text-[#646c6e]">© 2024 First Quantum Minerals. TSX Venture: FQM</p><p className="mono-font text-[9px] uppercase tracking-[.12em] text-[#646c6e]">Responsible by design / Vancouver, Canada</p></div>
    </div>
  </footer>;
}
...
function LeadershipSpotlight() {
  return <section className="bg-[#0c0f12]">
    <div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28">
      <div className="mb-12 flex items-end justify-between">
        <div><p className="eyebrow">Leadership</p><h2 className="display-font mt-4 text-4xl text-[#f1e9db] md:text-5xl">People with range.</h2></div>
        <Linkedin size={19} className="text-[#e8aa62]" />
      </div>
      <div className="border border-white/10 bg-[#151a1e]">
        <div className="grid md:grid-cols-[.8fr_1.2fr]">
          <div className="relative min-h-[390px] overflow-hidden md:min-h-[480px]">
            <img src="/leadership/sarah-thompson.jpg" alt="Sarah Thompson, Member of the Board of Directors and Head of Mining and Production" className="absolute inset-0 h-full w-full object-cover object-center" />
            <div className="absolute inset-0 bg-gradient-to-t from-[#101318] via-transparent to-transparent" />
            <span className="absolute left-6 top-6 eyebrow bg-[#101318]/80 px-3 py-2 text-[#f1e9db]">Board / Operations</span>
          </div>
          <div className="flex flex-col justify-between p-7 md:p-12">
            ...
            <div className="mt-10 border-t border-white/10 pt-5">
              <p className="max-w-[620px] text-sm leading-6 text-[#92999a]">As a member of the Board, Sarah brings an operator’s perspective to the long-term choices that shape First Quantum Minerals — connecting responsible governance with the realities of safe, consistent production.</p>
            </div>
          </div>
        </div>
...
function Home() {
  return <div className="qmc-shell qmc-noise bg-[#101318] text-[#f1e9db]"><Header /><main>
    <section className="relative min-h-[720px] overflow-hidden border-b border-white/[.1] md:min-h-[820px]">
      ...
      <div className="relative mx-auto flex min-h-[720px] max-w-[1440px] flex-col justify-end px-5 pb-16 pt-32 md:min-h-[820px] md:px-10 md:pb-24"><div className="max-w-[900px] reveal"><div className="mb-7 flex items-center gap-4"><span className="eyebrow">Vancouver / Canada</span><span className="h-px w-16 bg-[#d58442]" /></div><p className="display-font text-3xl leading-none text-[#f1e9db] md:text-5xl">First Quantum Minerals</p><p className="mt-3 max-w-[590px] text-sm leading-6 text-[#aeb3b0] md:text-base">A Canadian mining company focused on the responsible development of the copper, nickel, gold, cobalt and zinc the modern world depends on.</p><h1 className="mt-9 display-font text-[clamp(3.4rem,9vw,8.4rem)] leading-[.84] text-[#f4eddf]">Materials<br /><span className="text-[#e8aa62]">with a future.</span></h1><p className="mt-8 max-w-[500px] text-base leading-7 text-[#c0c2bd] md:text-lg">We are building a focused minerals business for a more connected, electrified world — with the discipline to do it properly.</p><div className="mt-9 flex flex-wrap gap-3"><ButtonLink href="/operations">Explore our work</ButtonLink><ButtonLink href="/products" secondary>View our metals</ButtonLink></div></div><div className="mt-16 flex items-end justify-between border-t border-white/20 pt-5 reveal-3"><span className="mono-font text-[9px] uppercase tracking-[.16em] text-[#909594]">Scroll to discover</span><ArrowDownRight size={17} className="text-[#e8aa62]" /></div></div>
    </section>
     <section className="qmc-grid border-b border-white/[.1]"><div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28"><div className="grid gap-12 md:grid-cols-[.8fr_1.2fr] md:gap-24"><div><p className="eyebrow">The First Quantum point of view</p></div><div><h2 className="display-font max-w-[780px] text-4xl leading-[1.05] text-[#f1e9db] md:text-6xl">The world needs more minerals. It also needs better mining.</h2><p className="mt-7 max-w-[620px] text-base leading-7 text-[#aeb3b0]">We see responsible extraction as a promise, not a positioning line. It is how we choose ground, work with communities, manage water, build teams and earn the right to keep operating.</p><Link href="/about" className="mt-7 inline-flex items-center gap-3 mono-font text-[10px] uppercase text-[#e8aa62]" data-testid="link-home-about">Our story <CircleArrowOutUpRight size={15} /></Link></div></div></div></section>
    <section className="border-b border-white/[.1]"><div className="mx-auto grid max-w-[1440px] md:grid-cols-[1.05fr_.95fr]"><div className="relative min-h-[460px] overflow-hidden"><img src={operationsImage} alt="Haul trucks working on terraced benches at an open-pit mine" className="h-full w-full object-cover grayscale-[10%] transition-transform duration-700 hover:scale-105" /><div className="absolute inset-0 bg-gradient-to-t from-[#101318]/80 to-transparent" /><p className="absolute bottom-7 left-5 eyebrow md:left-10">Built for the long horizon</p></div><div className="flex flex-col justify-center px-5 py-16 md:px-16"><p className="eyebrow">A focused portfolio</p><h2 className="display-font mt-5 text-4xl leading-[1.03] text-[#f1e9db] md:text-5xl">Six materials.<br />One clear standard.</h2><p className="mt-6 max-w-[440px] text-sm leading-7 text-[#aeb3b0]">Copper, cobalt, nickel, gold, zinc and copper concentrate — each with a role in the global shift, and each requiring a different kind of care.</p><Link href="/products" className="mt-8 inline-flex items-center gap-3 mono-font text-[10px] uppercase text-[#e8aa62]" data-testid="link-home-products">Discover the portfolio <ArrowRight size={15} /></Link></div></div></section>
     <section className="qmc-grid border-b border-white/[.1]"><div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28"><div className="flex items-end justify-between gap-6"><div><p className="eyebrow">The portfolio</p><h2 className="display-font mt-4 text-4xl text-[#f1e9db] md:text-5xl">Materials with a job to do.</h2></div><Link href="/products" className="hidden items-center gap-2 mono-font text-[10px] uppercase text-[#e8aa62] md:inline-flex" data-testid="link-home-products-grid">All products <ArrowRight size={14} /></Link></div><div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">{products.map((product, index) => <Link href="/products" key={product.name} className="product-card group"><div className="relative aspect-[1.18] overflow-hidden"><img src={product.image} alt={`${product.name} ${product.form.toLowerCase()}`} className="h-full w-full object-cover transition duration-700 group-hover:scale-105" /><div className="absolute inset-0 bg-gradient-to-t from-[#101318] via-[#101318]/5 to-transparent" /><span className="absolute left-5 top-5 mono-font text-[10px] text-[#e8aa62]">{product.symbol}</span><span className="absolute bottom-5 left-5 product-type">{product.form}</span><ArrowUpRight size={17} className="absolute right-5 top-5 text-[#f1e9db] opacity-0 transition group-hover:opacity-100" /></div><div className="flex items-end justify-between gap-4 border-t border-white/10 bg-[#14191d] p-5"><div><h3 className="display-font text-2xl text-[#f1e9db]">{product.name}</h3><p className="mt-2 text-sm text-[#899192]">{product.tagline}</p></div><ChevronRight size={17} className="mb-1 shrink-0 text-[#e8aa62]" /></div></Link>)}</div></div></section>
    <section className="border-b border-white/[.1] bg-[#0c0f12]"><div className="mx-auto max-w-[1440px] px-5 py-16 md:px-10 md:py-20"><p className="eyebrow">First Quantum in numbers</p><div className="mt-9 grid grid-cols-2 gap-px bg-white/10 md:grid-cols-4">{[['06','materials in focus'],['03','core jurisdictions'],['24','month operating lens'],['01','connected team']].map(([value, label]) => <div key={label} className="bg-[#0c0f12] p-5 md:p-7"><p className="display-font text-5xl text-[#e8aa62] md:text-6xl">{value}</p><p className="mt-3 max-w-[150px] mono-font text-[9px] uppercase leading-4 text-[#7c8586]">{label}</p></div>)}</div></div></section>
     <LeadershipSpotlight />
    <section className="border-b border-white/[.1]"><div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28"><div className="flex items-end justify-between gap-6"><div><p className="eyebrow">Where we work</p><h2 className="display-font mt-4 max-w-[760px] text-4xl leading-[1.03] text-[#f1e9db] md:text-5xl">The strongest global supply chains start with trust built close to the ground.</h2><p className="mt-6 max-w-[660px] text-base leading-7 text-[#aeb3b0]">First Quantum Minerals connects Vancouver-based capital and technical discipline with the people, operating realities and natural systems that define each project.</p></div><Link href="/operations" className="hidden items-center gap-2 mono-font text-[10px] uppercase text-[#e8aa62] md:inline-flex" data-testid="link-home-operations">Explore operations <ArrowRight size={14} /></Link></div><div className="mt-10 grid gap-5 md:grid-cols-3">{[['Canada','Vancouver / Head office','Strategy, partnerships and capital'],['North America','Western corridor','Exploration and project development'],['Global markets','Connected by trade','Customers, partners and end users']].map(([region, place, copy], index) => <div key={region} className="card-lift border border-white/10 bg-[#151a1e] p-7 md:min-h-[220px] md:p-9"><div className="flex items-center justify-between"><Globe2 size={20} className="text-[#e8aa62]" /><span className="mono-font text-[9px] text-[#687173]">0{index + 1}</span></div><h3 className="display-font mt-14 text-2xl text-[#f1e9db]">{region}</h3><p className="mt-2 text-sm text-[#e8aa62]">{place}</p><p className="mt-4 text-sm leading-6 text-[#92999a]">{copy}</p></div>)}</div></div></section>
    <section className="bg-[#0c0f12]"><div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28"><div className="flex flex-col justify-between gap-8 md:flex-row md:items-end"><div><p className="eyebrow">What guides us</p><h2 className="display-font mt-5 max-w-[760px] text-4xl leading-[1] text-[#f1e9db] md:text-5xl">The value we create should still be visible after the shipment leaves.</h2><p className="mt-6 max-w-[620px] text-base leading-7 text-[#aeb3b0]">That means safer work, stronger local capability, better environmental decisions and the operating discipline to keep improving when nobody is watching.</p></div><ButtonLink href="/sustainability" secondary>Our responsibility</ButtonLink></div><div className="mt-14 grid gap-px bg-white/[.12] md:grid-cols-3">{[['01','Listen before we act','The people closest to a project help shape how it moves forward, from early studies to long-term partnership.'],['02','Make performance measurable','Clear systems for safety, water, energy and capital turn good intentions into decisions we can test.'],['03','Leave capability behind','Local procurement, skills and durable relationships are part of the return—not an afterthought to production.']].map(([num, title, copy]) => <div key={num} className="bg-[#0c0f12] p-7 md:p-9"><span className="mono-font text-xs text-[#e8aa62]">{num}</span><h3 className="display-font mt-14 text-2xl text-[#f1e9db]">{title}</h3><p className="mt-3 text-sm leading-6 text-[#949b9b]">{copy}</p></div>)}</div></div></section>
    <section className="qmc-grid border-t border-white/[.1]"><div className="mx-auto max-w-[1440px] px-5 py-20 md:px-10 md:py-28"><div className="flex items-end justify-between gap-6"><div><p className="eyebrow">Latest insights</p><h2 className="display-font mt-4 text-4xl text-[#f1e9db] md:text-5xl">A closer look at the work.</h2></div><Link href="/contact" className="hidden items-center gap-2 mono-font text-[10px] uppercase text-[#e8aa62] md:inline-flex" data-testid="link-home-insights">Stay connected <ArrowRight size={14} /></Link></div><div className="mt-10 grid gap-5 md:grid-cols-3">{[['18 Jun 2024','Why copper still matters to the connected economy',copperImage],['02 May 2024','Listening first: building better community partnerships',mountainImage],['14 Mar 2024','The operating discipline behind responsible growth',operationsImage]].map(([date, title, image]) => <article key={title as string} className="group border border-white/10 bg-[#151a1e]"><div className="aspect-[1.5] overflow-hidden"><img src={image as string} alt="" className="h-full w-full object-cover opacity-65 grayscale transition duration-700 group-hover:scale-105 group-hover:opacity-90" /></div><div className="p-6"><p className="mono-font text-[9px] uppercase text-[#e8aa62]">{date as string} / 3 min read</p><h3 className="display-font mt-5 text-2xl leading-tight text-[#f1e9db]">{title as string}</h3><Link href="/about" className="mt-7 inline-flex items-center gap-2 mono-font text-[10px] uppercase text-[#aeb3b0] group-hover:text-[#e8aa62]" data-testid={`link-insight-${(title as string).slice(0, 10).replaceAll(' ', '-').toLowerCase()}`}>Read story <ArrowUpRight size={14} /></Link></div></article>)}</div></div></section>
  </main><Footer /></div>;
}

function About() {
  return <PageFrame eyebrow="About First Quantum Minerals" title={<>A Canadian company.<br /><span className="text-[#e8aa62]">A global outlook.</span></>} intro="We are a Vancouver-based minerals company with a practical ambition: build a resilient, responsible business that creates value well beyond the mine gate." image={mountainImage}>
    <section className="border-b border-white/[.1]"><div className="mx-auto grid max-w-[1440px] gap-12 px-5 py-20 md:grid-cols-[.8fr_1.2fr] md:gap-24 md:px-10 md:py-28"><p className="eyebrow">Our story</p><div><p className="display-font text-3xl leading-[1.1] text-[#f1e9db] md:text-5xl">First Quantum Minerals was shaped in Vancouver, a city that knows the value of both natural resources and global connection.</p><p className="mt-7 max-w-[650px] text-base leading-7 text-[#aeb3b0]">We bring a grounded, technically minded approach to mineral development. Our portfolio is designed to be focused rather than sprawling, and our partnerships are built for the long term. The result is an operator that can move with conviction without losing sight of the details.</p></div></div></section>
...
const products = [
  { name: 'Copper cathodes', symbol: 'Cu', tagline: 'Conductivity for a connected world', description: 'High-purity copper cathodes for power, construction, transport and the infrastructure between them.', detail: 'Copper is the quiet architecture of modern life. First Quantum Minerals approaches its production with a focus on consistency, traceability and the customers who rely on every shipment.', image: '/qmc-products/copper-cathodes.jpg', form: 'Cathode plates', origin: 'Refined copper', uses: 'Power · Construction · Transport' },
  { name: 'Copper concentrate', symbol: 'Cu', tagline: 'The starting point for more', description: 'A versatile feedstock for smelters and refiners across global supply chains.', detail: 'Our concentrate strategy is built around predictable quality and clear communication from source to customer.', image: '/qmc-products/copper-concentrate.jpg', form: 'Mineral concentrate', origin: 'Copper-bearing ore', uses: 'Smelting · Refining · Manufacturing' },
  { name: 'Nickel', symbol: 'Ni', tagline: 'The metal in motion', description: 'A critical ingredient in high-performance alloys and the energy transition.', detail: 'Nickel gives systems strength, density and endurance — qualities we bring to the way we work as well.', image: '/qmc-products/nickel-metal.jpg', form: 'Pellets & briquettes', origin: 'Refined nickel metal', uses: 'Stainless steel · Alloys · Batteries' },
  { name: 'Gold', symbol: 'Au', tagline: 'Value with staying power', description: 'A store of value and a material with enduring relevance in technology and industry.', detail: 'We treat gold as a long-horizon resource: carefully evaluated, responsibly advanced and transparently presented.', image: '/qmc-products/gold-bullion.jpg', form: 'Bullion bars', origin: 'Refined precious metal', uses: 'Reserve assets · Technology · Jewellery' },
  { name: 'Cobalt', symbol: 'Co', tagline: 'Strength at the core', description: 'A specialist metal supporting energy storage, superalloys and high-reliability applications.', detail: 'Cobalt calls for precision across the value chain. Our focus is on responsible sourcing and practical transparency.', image: '/qmc-products/cobalt-ore.jpg', form: 'Cobalt-bearing ore', origin: 'Mineral concentrate', uses: 'Energy storage · Superalloys · Catalysts' },
  { name: 'Zinc', symbol: 'Zn', tagline: 'Protection, by nature', description: 'A versatile metal that extends the life of steel and protects the systems we build.', detail: 'Zinc is a small intervention with a large effect — helping infrastructure last longer and use resources better.', image: '/qmc-products/zinc-ingots.jpg', form: 'Cast ingots', origin: 'Refined zinc metal', uses: 'Galvanizing · Brass · Die casting' },
];
...
function Products() {
  ...
  return <PageFrame eyebrow="Products" title={<>The materials<br /><span className="text-[#e8aa62]">behind momentum.</span></>} intro="A considered portfolio of six metals — each with a distinct market, a practical use and a role in the systems people depend on." image={copperImage}>
      <section className="border-b border-white/[.1]"><div className="mx-auto max-w-[1440px] px-5 py-16 md:px-10 md:py-24"><div className="grid gap-10 md:grid-cols-[.62fr_1.38fr] md:gap-16"><div className="product-index">{products.map((item, index) => <button type="button" key={item.name} onClick={() => setSelected(index)} className={`product-index-item group ${selected === index ? 'is-selected' : ''}`} data-testid={`button-product-${item.symbol}`}><span className="flex items-center gap-4"><span className="mono-font text-[10px] text-[#596264]">0{index + 1}</span><span className="display-font text-2xl">{item.name}</span></span><ChevronRight size={17} /></button>)}</div><div className="product-feature"><div className="product-feature-image"><img src={product.image} alt={`${product.name} ${product.form.toLowerCase()}`} /><div className="absolute inset-0 bg-gradient-to-t from-[#101318] via-transparent to-transparent" /><div className="absolute left-6 top-6 flex items-center gap-3"><span className="product-symbol">{product.symbol}</span><span className="eyebrow text-[#f1e9db]">Material / {String(selected + 1).padStart(2, '0')}</span></div><p className="absolute bottom-6 left-6 product-type text-[#f1e9db]">{product.form}</p></div><div className="product-feature-copy"><div className="flex items-start justify-between gap-5"><div><p className="eyebrow">First Quantum portfolio</p><h2 className="display-font mt-3 text-4xl text-[#f1e9db] md:text-6xl">{product.name}</h2></div><span className="display-font text-5xl text-[#e8aa62]">{product.symbol}</span></div><p className="mt-7 max-w-[620px] text-base leading-7 text-[#c0c4c1]">{product.description}</p><div className="product-facts mt-10"><div><span>Form</span><strong>{product.form}</strong></div><div><span>Material</span><strong>{product.origin}</strong></div><div><span>Applications</span><strong>{product.uses}</strong></div></div><p className="mt-8 border-t border-white/10 pt-6 text-sm leading-6 text-[#80898a]">{product.detail}</p></div></div></div></div></section>
...
function Careers() {
  return <PageFrame eyebrow="Careers" title={<>Make the work<br /><span className="text-[#e8aa62]">matter.</span></>} intro="Join a team that thinks like an owner, learns in the open and understands that the best work is measured by what it makes possible for others." image={operationsImage}>
    <section className="border-b border-white/[.1]"><div className="mx-auto grid max-w-[1440px] gap-12 px-5 py-20 md:grid-cols-[.8fr_1.2fr] md:gap-24 md:px-10 md:py-28"><p className="eyebrow">Life at First Quantum</p><div><p className="display-font text-3xl leading-[1.08] text-[#f1e9db] md:text-5xl">Small enough to know your work matters. Serious enough to make it count.</p><p className="mt-7 max-w-[650px] text-base leading-7 text-[#aeb3b0]">We bring together geologists, operators, analysts, community builders and curious generalists. Different disciplines, one standard: do the work properly and leave the room better than we found it.</p></div></div></section>
...
const pageMeta: Record<string, { title: string; description: string }> = {
  '/': { title: 'First Quantum Minerals | Materials with a future', description: 'First Quantum Minerals is a Vancouver-based mining company focused on responsible extraction, strong partnerships and the materials that move a connected world.' },
  '/about': { title: 'About First Quantum Minerals', description: 'Learn about First Quantum Minerals, our Vancouver roots, operating principles, leadership and long-horizon approach.' },
  '/operations': { title: 'Operations | First Quantum Minerals', description: 'Explore the First Quantum Minerals operating model, project opportunities and the regions where our work connects local knowledge to global relevance.' },
  '/products': { title: 'Products | First Quantum Minerals', description: 'Discover First Quantum Minerals’ portfolio of copper cathodes, copper concentrate, nickel, gold, cobalt and zinc.' },
  '/sustainability': { title: 'Responsibility | First Quantum Minerals', description: 'See how First Quantum Minerals approaches water stewardship, community partnerships, climate, energy, safety and wellbeing.' },
  '/investors': { title: 'Investor Centre | First Quantum Minerals', description: 'Find First Quantum Minerals strategy, portfolio context and investor information in one clear view.' },
  '/careers': { title: 'Careers | First Quantum Minerals', description: 'Join First Quantum Minerals and help build a focused minerals business with work that matters on the ground.' },
  '/contact': { title: 'Contact | First Quantum Minerals', description: 'Connect with First Quantum Minerals in Vancouver about partnerships, products, investing, communities or careers.' },
};

function PageMeta({ location }: { location: string }) {
  useEffect(() => {
    const meta = pageMeta[location] ?? { title: 'First Quantum Minerals', description: 'First Quantum Minerals is a Vancouver-based mining company.' };
